...
echo arrowKtVersion=$VERSION_NAME >> .trykotlin/versions/1.0.7/gradle.properties
echo arrowKtVersion=$VERSION_NAME >> .trykotlin/versions/1.1.60/gradle.properties
echo arrowKtVersion=$VERSION_NAME >> .trykotlin/versions/1.2.31/gradle.properties
